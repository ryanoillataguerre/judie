...
export interface IInferenceServiceServer {
    getChatResponse: grpc.handleServerStreamingCall<inference_service_pb.Conversation, inference_service_pb.TutorResponse>;
...
export interface IInferenceServiceClient {
    getChatResponse(request: inference_service_pb.Conversation, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<inference_service_pb.TutorResponse>;
    getChatResponse(request: inference_service_pb.Conversation, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<inference_service_pb.TutorResponse>;
...
export class InferenceServiceClient extends grpc.Client implements IInferenceServiceClient {
    ...
    public getChatResponse(request: inference_service_pb.Conversation, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<inference_service_pb.TutorResponse>;
    public getChatResponse(request: inference_service_pb.Conversation, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<inference_service_pb.TutorResponse>;
