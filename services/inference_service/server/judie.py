...
def grab_user_profile(user_id: str) -> UserProfile:
    user_obj = prisma_manager.get_user_from_db(user_id)
    profile_obj = prisma_manager.get_user_profile_from_db(user_id)
...
def grab_chat_config(chat_id: str) -> SessionConfig:
