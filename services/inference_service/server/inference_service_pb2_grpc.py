...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetChatResponse = channel.unary_unary(
                '/inferenceservice.InferenceService/GetChatResponse',
...
class InferenceService(object):
    ...
    def GetChatResponse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/inferenceservice.InferenceService/GetChatResponse',
